  ...
  ----------------------
  Java keytool:
  keytool -storetype PKCS12 -list -keystore Oxi-test-sandbox.p12 -storepass keystorepassword -v

  OpenSSL:
  openssl pkcs12 -info -in Oxi-test-sandbox.p12 -password pass:keystorepassword
