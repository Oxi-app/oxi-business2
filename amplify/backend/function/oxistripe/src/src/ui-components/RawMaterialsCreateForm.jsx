...
export default function RawMaterialsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new RawMaterials(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "RawMaterialsCreateForm")}
      {...rest}
    >
      <TextField
        label="Barcode"
